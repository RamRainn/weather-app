...
const currentWatherItemsEl = document.getElementById('current-weather-items');
...
const API_KEY = '2959da98f41d3e386a55464cc1946688';
...
function showWeatherData(data) {
    ...
    data.daily.forEach((day, idx) => {
        if (idx == 0) {
            ...
            <div class="day">${window.moment(day.dt*1000).format('ddd')}</div>
            <img src="http://openweathermap.org/img/wn/${day.weather[0].icon}@2x.png" class="w-icon" icon" alt="">
            <div class="temp">Night - ${day.temp.night}&#176; C</div>
            <div class="temp">Day - ${day.temp.day}&#176; C</div>
            </div>
    ...
    weatherForecastEl.innerHTML =  otherDaysForcast;
}
